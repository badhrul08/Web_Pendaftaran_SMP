...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="container mb-3">
          <div class="d-flex align-items-center">
            <div class="site-logo mr-auto">
              <a href="index.html">SMP 8 BOGOR<span class="text-primary">.</span></a>
            </div>
            <div class="site-quick-contact d-none d-lg-flex ml-auto ">
              <div class="d-flex site-info align-items-center mr-5">
                <span class="block-icon mr-3"><span class="icon-map-marker text-yellow"></span></span>
                <span>Jl. Anggrek Raya No. 16, Bogor, <br> Indonesia</span>
              </div>
              <div class="d-flex site-info align-items-center">
                <span class="block-icon mr-3"><span class="icon-clock-o"></span></span>
                <span>Senin - Jum'at 07.00 WIB - 17:00 WIB</span>
              </div>
    ...
    <div class="ftco-blocks-cover-1">
       <!-- data-stellar-background-ratio="0.5" style="background-image: url('../../assets/style/images/Kids.jpg')" -->
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('../../assets/style/images/Kids.jpg')">
        <div class="container">
          <div class="row align-items-center ">
            ...
            <div class="col-md-5 mt-5 pt-5">
              ...
              <h3 class="text-white m-0">Motto Kami</h3>
              <h3 class="text-white m-0">Bersih Rapih Disiplin</h3>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <span class="text-cursive h5 text-red d-block">Galeri Kami</span>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/smp-1.jpeg" data-fancybox="gal"><img src="../../assets/style/images/smp-1.jpeg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/smp-2.jpg" data-fancybox="gal"><img src="../../assets/style/images/smp-2.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/smp-3.jpg" data-fancybox="gal"><img src="../../assets/style/images/smp-3.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/smp-4.jpg" data-fancybox="gal"><img src="../../assets/style/images/smp-4.jpg" alt="Image" class="img-fluid"></a>
          </div>

          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/smp-5.jpg" data-fancybox="gal"><img src="../../assets/style/images/smp-5.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/smp-6.jpg" data-fancybox="gal"><img src="../../assets/style/images/smp-6.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/smp-7.jpg" data-fancybox="gal"><img src="../../assets/style/images/smp-7.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/smp-8.jpg" data-fancybox="gal"><img src="../../assets/style/images/smp-8.jpg" alt="Image" class="img-fluid"></a> 
          </div>
        </div>
      </div>
    </div>
